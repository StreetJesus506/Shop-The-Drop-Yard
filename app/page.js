...
const brands = [
  {
    ...
    ethos: 'Anti-capitalist streetwear. No bosses, no landlords, no masters.',
    tag: 'POLITICAL',
    accent: '#b01e28',
    bg: '#b01e28',
    text: '#f3e9e2',
  ...
  },
  {
    ...
    ethos: 'Farm-to-fit graphics for the high-minded.',
    tag: 'HERBAL',
    accent: '#46522f',
    bg: '#46522f',
    text: '#f1ead4',
  ...
  },
  {
    ...
    ethos: 'Built on the struggle, worn with purpose. Pro-Black, no apologies.',
    tag: 'LEGACY',
    accent: '#c9a24a',
    bg: '#0b0b0b',
    text: '#ece4cf',
    stamp: 'HANDLE W/ PRIDE',
  },
  {
    id: 'deadair',
    lot: '04',
    name: 'Dead Air',
    full: 'Dead Air',
    ethos: 'Cult cinema. Retro pop culture. Channel-surf graphics, rerun energy.',
    tag: 'NOSTALGIA',
    accent: '#2ee6d6',
    bg: '#11111c',
    text: '#dfe6f0',
